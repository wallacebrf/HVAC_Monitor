...
//***************************************
$database_column="firstfloormail";
$servername = "127.0.0.1:3307";
$username = "root";
$password = "password";
$dbname = "home_temp";
$message_subject='First Floor Temperature Monitor';
$message_body='The average house temperature has dropped below '.$min_temp.' degrees<br>Check the status of the house cooling system';
$message_altbody='The average house temperature has dropped below '.$min_temp.' degrees. Check the status of the house cooling system';
